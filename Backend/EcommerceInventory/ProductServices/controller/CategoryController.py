...
from EcommerceInventory.Helper import CustomPageNumberPagination
...
class CategoryListView(generics.ListAPIView):
    ...
    def list(self, request, *args, **kwargs):
        ...
        return renderResponse(
            data={'data': data, 'totalPages': total_pages, 'currentPage': current_page, 'pageSize': page_size, 'totalItems': total_items}, 
            message='Categoties retrieved successfully', 
            status=200, 
        )
